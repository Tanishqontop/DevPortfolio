...
>(({ className, children, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-[24px] bg-black/50 p-2 no-underline shadow-sm transition-colors hover:bg-black/100 dark:bg-white dark:hover:bg-white/90",
  ...
  >
    ...
    <div className="absolute inset-0 rounded-[16px]">
      ...
      <div
        className={cn(
          "absolute inset-0 rounded-[16px]",
          "dark:shadow-[0px_1px_1px_0px_rgba(0,0,0,0.65),0px_1px_1px_0px_rgba(0,0,0,6.15)_inset,0px_0px_0px_1px_rgba(0,0,0,0.15)_inset,0px_0px_1px_0px_rgba(0,0,0,0.15)]"
        )}
      />
    </div>
  </div>
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn("px-1 pb-2 text-sm text-neutral-700", className)}
    {...props}
  />
));
