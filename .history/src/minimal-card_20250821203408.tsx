...
// Updated MinimalCard with URL support
...
>(({ className, children, url, onClick, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "rounded-[24px] bg-white p-2 no-underline shadow-sm transition-colors hover:bg-gray-50 dark:bg-black dark:hover:bg-white/10",
  ...
  >
    ...
    <div className="absolute inset-0 rounded-[16px]">
      ...
      <div
        className={cn(
          "absolute inset-0 rounded-[16px]",
          "dark:shadow-[0px_1px_1px_0px_rgba(0,0,0,0.65),0px_1px_1px_0px_rgba(0,0,0,6.15)_inset,0px_0px_0px_1px_rgba(0,0,0,6.15)_inset,0px_0px_1px_0px_rgba(0,0,0,6.15)]"
        )}
      />
    </div>
  </div>
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn("mt-2 ml-2.5 px-1 text-lg font-semibold leading-tight text-gray-900 dark:text-white", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn("px-1 pb-2 text-sm text-gray-700 dark:text-white", className)}
    {...props}
  />
));
