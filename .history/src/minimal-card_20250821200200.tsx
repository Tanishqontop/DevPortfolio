...
>(({ className, children, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-[24px] bg-white p-2 no-underline shadow-sm transition-colors hover:bg-black dark:bg-black dark:hover:bg-white/90",
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn("mt-2 ml-2.5 px-1 text-lg font-semibold leading-tight text-white align-middle", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn("px-1 pb-2 text-sm text-white", className)}
    {...props}
  />
));
